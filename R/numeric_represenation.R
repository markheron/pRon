...
#' @param method ("as.integer") one of"as.integer", "lookupTable", "slidingView" and "memoryLimited" they are different implementations that have different speed/memory tradeoffs
...
#' 
fasta2num <- function (fastas, oligo_length, method="as.integer", simplify=TRUE) {
